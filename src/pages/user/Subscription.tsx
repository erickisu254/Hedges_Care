    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        <div className="text-center max-w-3xl mx-auto mb-8">
          <h1 className="text-4xl font-bold text-green-800 mb-4">Upgrade Your Indoor & Outdoor Experience</h1>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td className="p-3 border-b">Plant Library Access</td>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-lg text-green-700 mb-8 max-w-2xl mx-auto">
            Our team is ready to help you choose the right plan for your Landcaping needs.
          </p>
